...
export function aggregateByYearStacked(items) {
    ...
    /*return {
        names,
        series: [
            { name: '2024 Текущая',   stack: '2024', data: current2024 },
            { name: '2024 Просроченная', stack: '2024', data: overdue2024 },
            { name: '2025 Текущая',   stack: '2025', data: current2025 },
            { name: '2025 Просроченная', stack: '2025', data: overdue2025 }
        ]
    };*/
